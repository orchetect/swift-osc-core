...
@Suite
struct OSCPacket_Properties_Tests {
    @Test
    func messages_Message() {
    ...
    @Test
    func messages_Bundle_oneMessage() {
        let msg = OSCMessage("/test", values: [123, "a string"])
    ...
    @Test
    func messages_Bundle_multipleMessages() {
    ...
    @Test
    func messages_Bundle_nestedBundles() {
