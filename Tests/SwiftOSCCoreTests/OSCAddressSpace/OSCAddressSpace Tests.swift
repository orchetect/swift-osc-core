...
struct OSCAddressSpace_Tests {
    ...
    @Test
    func registerAddress_PathComponents() async {
    ...
    @Test
    func registerAddress_PathComponents_CustomMethodIDType() async {
    ...
    @Test
    func registerAddress_EmptyAddress() async {
    ...
    @Test
    func registerAddress_PathComponents_EmptyAddress() async {
        // only asserts in debug builds. only testable with Xcode 26+ on macOS.
        #if os(macOS) && DEBUG && compiler(>=6.2)
        await #expect(processExitsWith: .failure) {
            let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_PathComponents() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_MethodID() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func registerAddress_MethodThatAlsoBecomesAContainer() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func registerAddress_ContainerThatBecomesAMethod() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_MethodThatAlsoBecomesAContainer_RemoveMethod() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_ContainerThatBecomesAMethod_RemoveMethod() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_MethodThatAlsoBecomesAContainer_RemoveContainer() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_ContainerThatBecomesAMethod_RemoveContainer() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func unregisterAddress_CustomMethodIDType() async {
        enum MyMethodID /* : Equatable, Hashable, Sendable */ {
            case one
            case two
            case three
    ...
    @Test
    func unregisterAllAddresses() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func methodsMatching_Root() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func methodsMatching_NestedMethods() async {
        let addressSpace = OSCAddressSpace()
    ...
    @Test
    func methodsMatching_MultipleContainerMatches() async {
        let addressSpace = OSCAddressSpace()
